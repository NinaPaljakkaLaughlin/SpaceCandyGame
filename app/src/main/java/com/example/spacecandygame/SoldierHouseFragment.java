    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        battleButton.setOnClickListener(v -> {
            ...
            if (!selectedSoldier.canEnterBattle()) {
                statsText.setText(selectedSoldier.getName() + " needs 50 XP to enter battle!");
                return;
            }
            ...
            new AlertDialog.Builder(getContext())
                    ...
                    .setItems(otherNames, (dialog, which) -> {
                        ...
                        requireActivity().getSupportFragmentManager()
                                .beginTransaction()
                                .replace(R.id.main, MissionFragment.newInstance(selectedSoldier.getId(), secondPlayer.getId()))
                                .addToBackStack(null)
                                .commit();
                    })
